...
<div class="swiper-slide">
    <div class="slider-item">
        <div class="img-slider">
            <img class="img-item lazyload" data-src="{{ $images[0] }}" src="{{ $images[0] }}" alt="">
        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="content po-content-two">
                        <div class="heading">
                            <h1 class="text-color-1 fade-item fade-item-1">{{ $vehicle->name }}</h1>
                            <ul class="ul flex flex-wrap category-list-car fade-item fade-item-2">
                                <li class="flex-three">
                                    <div class="icon">
                                    ...
                                    <div class="font text-color-1">{{ $vehicle->condition }}</div>
                                </li>
                                <li class="flex-three">
                                    <div class="icon">
                                        <svg width="26" height="26" viewBox="0 0 26 26" fill="none"
                                    ...
                                    <div class="font text-color-1">{{ $vehicle->millage }} kms</div>
                                </li>
                                <li class="flex-three">
                                    <div class="icon">
                                        <svg width="26" height="26" viewBox="0 0 26 26" fill="none"
                                    ...
                                    <div class="font text-color-1">Ksh {{ number_format($vehicle->price) }}</div>
                                </li>
                            </ul>
                            <div class="chat-wrap flex-three fade-item fade-item-3">
                                <a href="javascript:;"
                                ...
                                <div class="flex-three">
                                    <div class="image">
                                        <img class="img-item lazyload" data-src="{{ $vehicle->user->profile }}"
                                            src="{{ $vehicle->user->profile }}" alt="">
                                    </div>
                                    <div class="content-chat">
                                        <div class="fs-16 text-color-1">
                                            {{ $vehicle->user->company ?? $vehicle->user->name }}</div>
                                        <span class="fs-12 text-color-1">{{ timeago($vehicle->created_at) }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
