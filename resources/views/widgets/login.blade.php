<div class="content">
        ...
        <div class="respond-comment">
            <form method="post" class="comment-form form-submit" action="{{ route('login') }}" accept-charset="utf-8">
                ...
                <fieldset class="">
                    ...
                    <input type="text" id="text" class="tb-my-input" name="email" placeholder="Your name"
                        required>
                    <div class="icon">
    ...
    <div class="text-box text-center fs-14">Don’t you have an account? <a
            class="font-2 fw-7 fs-14 color-popup text-color-3" data-toggle="modal" data-target="#popup_bid2"
