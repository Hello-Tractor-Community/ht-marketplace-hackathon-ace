<div class="images flex-none relative">
    <img src="/assets/images/section/register.jpg" alt="images">
</div>
<div class="content">
    <h1 class="title-login">Register</h1>
    <div class="comments">
        <div class="respond-comment">
            <form method="post" class="comment-form form-submit" action="{{ route('register') }}" accept-charset="utf-8"
                novalidate="novalidate">
                @csrf
                <fieldset class="">
                    <label class="fw-6">Name</label>
                    <input type="text" class="tb-my-input" name="name" placeholder="Name" required>
                    <div class="icon">
                ...
                <fieldset class="t">
                    ...
                    <input type="email" class="tb-my-input" name="email" placeholder="Email address" required>
                    <div class="icon">
                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <fieldset class="">
                    ...
                    <div toggle="#password-field1" class="fa fa-fw fa-eye field-icon toggle-password"></div>
                    <div class="icon">
                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
    ...
    <div class="text-box text-center fs-14">Don’t you have an account?<a
            class="font-2 fw-7 fs-14 color-popup text-color-3" data-toggle="modal" data-target="#popup_bid"
            data-dismiss="modal" aria-label="Close">Login</a></div>
    <p class="texts line fs-12 text-center">or Register with</p>
    <div class="button-box flex">
        <a href="{{ route('google.redirect') }}" class="flex align-center">
