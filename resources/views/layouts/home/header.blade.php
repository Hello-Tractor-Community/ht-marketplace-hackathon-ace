 <!-- Main Header -->
 <header class="main-header @if (url()->current() == route('home')) style2 @endif">
     <!-- Header Lower -->
                     ...
                     <div class="inner-container flex justify-space align-center">
                         ...
                         <div class="logo-box flex">
                             <div class="logo"><a href="{{ route('home') }}">
                                     <img class="lazyload img-none" data-src="/assets/images/logo/logo2.png"
                                         src="/assets/images/logo/logo2.png" alt="" width="225"
                                         height="40">
                                     <img class="lazyload img-is-fixed" data-src="assets/images/logo/logo2x.png"
                                         src="/assets/images/logo/logo2x.png" alt="" width="225"
                                         height="40">
                                 </a></div>
     ...
     <div class="mobile-menu">
         ...
         <nav class="menu-box">
             <div class="nav-logo"><a href="{{ route('home') }}">
                     <img class="lazyload" data-src="/assets/images/logo/logo2x.png"
                         src="/assets/images/logo/logo2x.png" alt="" width="197" height="48"></a>
             </div>
             <div class="bottom-canvas">
                 <div class="login-box flex align-center">
                     <i class="icon-autodeal-user fs-20"></i>
                     <a href="#" data-bs-toggle="modal" data-bs-target="#popup_bid" class="fw-7 font-2">Login</a>
                 </div>
